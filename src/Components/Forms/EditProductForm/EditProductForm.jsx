    ...
    <div>
      <form className="edit-product">
        <div className="edit-product-heading">
          {innerWidth < 600 ? <span>Edit your product</span> : null}
        </div>
        <div className="edit-product-company-input">
          <input
            value={companyName}
        ...
        <div className="edit-product-category-input">
          <input
            value={category}
        ...
        <div className="edit-product-logo-input">
          <input
            value={imageURL}
        ...
        <div className="edit-product-product-link-input">
          <input
            value={productLink}
        ...
        <div className="edit-product-description-input">
          <input
            value={description}
